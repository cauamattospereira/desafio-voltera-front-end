...
<!-- logo -->
  ...
  <div style="display: flex; gap: 0.75rem;">
    ...
    <div class="main-section" style="display: flex; flex-direction: column; align-items: center; gap: 1rem;">
          ...
          ">
            ...
            ">
                ...
                <button
                    ...
                    aria-label="github"
                >
                  <a href="https://github.com/cauamattosprj" target="_blank" aria-label="github">
                ...
                <button
                    ...
                    gap: 0.75rem;
                        ...
                        aria-label="linkedin"
                    >
                    <a href="https://www.linkedin.com/in/caua-mattos" target="_blank" aria-label="linkedin">
                      <svg xmlns="http://www.w3.org/2000/svg" fill="white" height="24" width="24" viewBox="0 0 24 24">
                          <path d="M4.98 3.5C4.98 4.88 3.88 6 2.5 6S0 4.88 0 3.5 1.12 1 2.5 1s2.48 1.12 2.48 2.5zM.5 8h4V24h-4V8zm7.5 0h3.6v2.2h.05c.5-.95 1.72-2 3.55-2 3.8 0 4.5 2.5 4.5 5.7V24h-4v-7.2c0-1.7 0-3.9-2.4-3.9-2.4 0-2.7 1.9-2.7 3.8V24h-4V8z"/>
                      </svg>
                    </a>
                ...
                <button
                    ...
                    gap: 0.75rem;
                        ...
                        aria-label="gmail"
                    >
                    <a href="mailto:caua.h4k@gmail.com" target="_blank" aria-label="gmail">
                      <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="24" height="24" viewBox="0 0 48 48">
                        <path fill="#4caf50" d="M45,16.2l-5,2.75l-5,4.75L35,40h7c1.657,0,3-1.343,3-3V16.2z"></path><path fill="#1e88e5" d="M3,16.2l3.614,1.71L13,23.7V40H6c-1.657,0-3-1.343-3-3V16.2z"></path><polygon fill="#e53935" points="35,11.2 24,19.45 13,11.2 12,17 13,23.7 24,31.95 35,23.7 36,17"></polygon><path fill="#c62828" d="M3,12.298V16.2l10,7.5V11.2L9.876,8.859C9.132,8.301,8.228,8,7.298,8h0C4.924,8,3,9.924,3,12.298z"></path><path fill="#fbc02d" d="M45,12.298V16.2l-10,7.5V11.2l3.124-2.341C38.868,8.301,39.772,8,40.702,8h0 C43.076,8,45,9.924,45,12.298z"></path>
                      </svg>
                    </a>
      ...
      <div>
        <!-- whatsapp btn -->
        <a href="https://wa.me/21972045968/" target="_blank" aria-label="whatsapp">
          <button
          style="
          display: flex;
          align-items: center;
